...
<nav>
    ...
    <ul>
        <li><a href="<?php if($url == "updateClient" or $url == "updateProduct"){echo '../index.php';}else{echo './index.php';};?>" <?php if($url == "index" or $url == "EX_11_03"){echo "class='active-url meumenu'";}else{echo "class='meumenu'";}?> title="Home" ><i class="fa-solid fa-home"></i>Home</a></li>
